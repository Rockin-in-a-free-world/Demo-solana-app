...
var _chunk2EIX7ZYTcjs = require('./chunk-2EIX7ZYT.cjs');
...
var _chunkHD4O6IVCcjs = require('./chunk-HD4O6IVC.cjs');
...
var resolveHybridSigner = (config) => {
  ...
  const encodeSignature = ({ signature, webauthn }) => _chunkHD4O6IVCcjs.encodeDeleGatorSignature.call(void 0, 
    keyId,
    signature,
  ...
  const getStubSignature = async () => _chunkHD4O6IVCcjs.createDummyWebAuthnSignature.call(void 0, keyId);
  return {
    signMessage,
    signTypedData,
    getStubSignature
...
async function toMetaMaskSmartAccount(params) {
  ...
  const environment = _nullishCoalesce(params.environment, () => ( _chunkBFDBNFIPcjs.getSmartAccountsEnvironment.call(void 0, chain.id)));
  ...
  if (params.address) {
    ...
    const accountData = await _chunkHD4O6IVCcjs.getCounterfactualAccountData.call(void 0, {
  ...
  const signDelegation2 = async (delegationParams) => {
    ...
    const delegationStruct = _chunkHLCOMYYUcjs.toDelegationStruct.call(void 0, {
      ...delegation,
      signature: "0x"
    });
    const signature = signer.signTypedData({
      ...
      types: _chunkHLCOMYYUcjs.SIGNABLE_DELEGATION_TYPED_DATA,
  ...
  const signUserOperation2 = async (userOpParams) => {
    ...
    const signature = await signer.signTypedData({
      ...
      types: _chunkBFDBNFIPcjs.SIGNABLE_USER_OP_TYPED_DATA,
  ...
  const getNonce = async () => _chunk2EIX7ZYTcjs.read.call(void 0, {
    client,
    entryPoint: environment.EntryPoint,
    contractAddress: address,
    key: 0n
  });
  const encodeCalls = async (calls) => _chunkHD4O6IVCcjs.encodeCallsForCaller.call(void 0, address, calls);
  ...
  if (implementation === "Stateless7702" /* Stateless7702 */) {
    return {
      ...smartAccount,
      isDeployed: async () => _chunkWA2O2K3Kcjs.isValid7702Implementation.call(void 0, {
        client,
...
function createCaveatEnforcerClient({
  ...
  return client.extend(_chunkWA2O2K3Kcjs.caveatEnforcerActions.call(void 0, { environment }));
}
...
exports.ANY_BENEFICIARY = _chunkHLCOMYYUcjs.ANY_BENEFICIARY; exports.BalanceChangeType = _chunkHLCOMYYUcjs.BalanceChangeType; exports.ExecutionMode = _chunkT6PSFUOZcjs.ExecutionMode; exports.Implementation = _chunkHD4O6IVCcjs.Implementation; exports.PREFERRED_VERSION = _chunkBFDBNFIPcjs.PREFERRED_VERSION; exports.ROOT_AUTHORITY = _chunkHLCOMYYUcjs.ROOT_AUTHORITY; exports.TransferWindow = _chunkHD4O6IVCcjs.TransferWindow; exports.actions = _chunkWA2O2K3Kcjs.actions_exports; exports.aggregateSignature = aggregateSignature; exports.contracts = _chunk2EIX7ZYTcjs.contracts_exports; exports.createCaveat = _chunkHLCOMYYUcjs.createCaveat; exports.createCaveatEnforcerClient = createCaveatEnforcerClient; exports.createDelegation = _chunkHLCOMYYUcjs.createDelegation; exports.createExecution = _chunkT6PSFUOZcjs.createExecution; exports.createInfuraBundlerClient = createInfuraBundlerClient; exports.createOpenDelegation = _chunkHLCOMYYUcjs.createOpenDelegation; exports.getSmartAccountsEnvironment = _chunkBFDBNFIPcjs.getSmartAccountsEnvironment; exports.redeemDelegations = _chunkBFDBNFIPcjs.redeemDelegations; exports.signDelegation = _chunkHLCOMYYUcjs.signDelegation; exports.signUserOperation = _chunkBFDBNFIPcjs.signUserOperation; exports.toMetaMaskSmartAccount = toMetaMaskSmartAccount;
