...
var getCounterfactualAccountData = async ({
  ...
  switch (implementation) {
    case "Hybrid" /* Hybrid */: {
      ...
      initcode = _chunk662KDAAGcjs.encode.call(void 0, { eoaOwner: owner, p256Owners });
      break;
    }
    case "MultiSig" /* MultiSig */: {
      ...
      initcode = _chunk662KDAAGcjs.encode2.call(void 0, { owners, threshold });
      break;
    }
    default:
  ...
  const proxyCreationCode = _chunk662KDAAGcjs.encodeProxyCreationCode.call(void 0, {
  ...
  const factoryData = _chunk662KDAAGcjs.encode3.call(void 0, proxyCreationCode, salt);
  return {
    factoryData,
    address
  };
...
var encodeCalls = (calls) => {
  if (calls.length === 1) {
    ...
    if (call && !isDelegatedCall(call)) {
      ...
      return _chunk662KDAAGcjs.encode4.call(void 0, { execution });
    }
  }
  ...
  return _chunk662KDAAGcjs.encode5.call(void 0, { mode, executions });
};
...
function parseAuthenticatorFlags(authenticatorData) {
  const authenticatorDataBuffer = _viem.hexToBytes.call(void 0, authenticatorData);
...
//# sourceMappingURL=chunk-HD4O6IVC.cjs.map